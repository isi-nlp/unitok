...
def main():
  parser = argparse.ArgumentParser(description="given vocabulary, spit out 2gram fsa and w2c fst",
  ...
  for ln, line in enumerate(infile):
    ...
    words.append(modword)
    outfile.write("(START (%d \"%s\"))\n" % (len(words)-1, modword))
