...
# p = no punc substitute; g = map digits to @
$SCRIPTDIR/sent2ms.py -p -g -x 50 -i $WORKDIR/digsub -o $WORKDIR/ms;
# extra --classes 
LAST=2 ITERS=20 EXTRA="--classes" $SCRIPTDIR/../mit-arabic-segmenter-c++-release/train.bash $RANDOM $WORKDIR/ms $WORKDIR/base;
