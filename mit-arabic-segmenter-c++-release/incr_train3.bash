...
python2.7 run_segmenter.py -c $newfile -r 0 -i 50 -o $newstem-m1.dict -d $olddict1:smSMT
...
python2.7 run_segmenter.py -c $newfile -r 0 -i 50 -t 5 -o $newstem-m2.dict -d $olddict2:smtSMT -d $newstem-m1.dict:sm
python2.7 run_segmenter.py -c $newfile -r 0 -i 50 -t 5 -o $newstem-m3.dict -d $olddict3:smtSMT -d $newstem-m2.dict:smt -q
python2.7 run_segmenter.py -c $newfile -r 0 -i 50 -t 5 -o $newstem-m4.dict -d $olddict4:smtSMT -d $newstem-m3.dict:smt -q -a
